...
const Sidebar_Left = (props) =>{
    ...
    return <>
        ...
        <div className={props.scrollY>=180 && window.screen.availWidth>767? props.className +" md:m-4 md:bg-slate-300 sticky top-0 p-2 border-2 max-h-[35rem] overflow-x-hidden scrollbar-thin": props.className +" p-2 border-2 max-h-[35rem] overflow-x-hidden scrollbar-thin"}>
            {trending_news.articles.map(news=>{
                return <div className="flex flex-col justify-center p-2 my-4 border-b-2 cursor-pointer md:bg-white">
